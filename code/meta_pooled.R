...
# 
#                      
# ggsave(p, file='figures/pooled_effect.png', width=8, height=8)                 
# 
# 
# 
# to_graph<-data.frame("intervention"=c("All Mental Health Outcomes","UCT","CCT","Neighborhood","Asset", 'Grad','Lottery','Insurance' ),
...
# 
# 
# ggsave(p, file='figures/pooled_effect_int.png')                 
# 
# a<-temp_reg
# robust(temp_reg,cluster=data)
# 
# 
# 
