...
for(i in c('int_All', 'int_UCT','int_CCT', 'int_Neighborhood', 'int_Grad', 'int_Lottery', 'int_Asset', 'int_Healthcare')) {
  ...
  consolidated<- data.frame("variable"=c("","Constant","","","Age","","","LMIC","","","Female Share","","","Lumpsum","","","Value/GDPPC","","","Delay-Intervention (Years)","","","Obs/Studies","" ),
...
names(consolidated.final)<-c('','All', 'UCT','CCT','Neighborhood','Grad','Lottery', 'Asset','Healthcare')
...
print(metareg.tex, file = "tables/metareg.tex", compress = FALSE, 
