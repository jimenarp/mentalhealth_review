...
for(i in c('int_All', 'int_in_kind', 'int_in_cash')) {
  tryCatch({
    ...
    consolidated<- data.frame("variable"=c("","Constant","","","Age","","","LMIC","","","Female Share","","","Lumpsum","","","Intervention Value","(as % of GDP per Capita)","","Delay Intervention-Survey","(Years)","","Obs/Studies","" ),
...
print(metareg.tex, file = "tables/metareg_clustered_twocat.tex", compress = FALSE, 
