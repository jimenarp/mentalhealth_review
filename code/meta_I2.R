...
consolidated.all<- data.frame("group"=c("","All Interventions","","" ),
                              "Reg 1"=c("",I2_All_All,ns_All_All,""),
                              "Reg 2"=c("",I2_All_Depression,ns_All_Depression,""),
                              "Reg 3"=c("",I2_All_Stress_Anx,ns_All_Stress_Anx,""),
                              "Reg 4"=c("",I2_All_Happy_Sat,ns_All_Happy_Sat,"")
)



consolidated.UCT<- data.frame("group"=c("Unconditional Cash Transfer","","" ),
                              "Reg 1"=c(I2_UCT_All,ns_UCT_All,""),
                              "Reg 2"=c(I2_UCT_Depression,ns_UCT_Depression,""),
                              "Reg 3"=c(I2_UCT_Stress_Anx,ns_UCT_Stress_Anx,""),
                              "Reg 4"=c(I2_UCT_Happy_Sat,ns_UCT_Happy_Sat,"")
)



consolidated.CCT<- data.frame("group"=c("Conditional Cash Transfer","","" ),
                              "Reg 1"=c(I2_CCT_All,ns_CCT_All,""),
                              "Reg 2"=c(I2_CCT_Depression,ns_CCT_Depression,""),
                              "Reg 3"=c(I2_CCT_Stress_Anx,ns_CCT_Stress_Anx,""),
                              "Reg 4"=c(I2_CCT_Happy_Sat,ns_CCT_Happy_Sat,"")
)


consolidated.Neighborhood<- data.frame("group"=c("Housing Voucher","","" ),
                                       "Reg 1"=c(I2_Neighborhood_All,ns_Neighborhood_All,""),
                                       "Reg 2"=c(I2_Neighborhood_Depression,ns_Neighborhood_Depression,""),
                                       "Reg 3"=c(I2_Neighborhood_Stress_Anx,ns_Neighborhood_Stress_Anx,""),
                                       "Reg 4"=c(I2_Neighborhood_Happy_Sat,ns_Neighborhood_Happy_Sat,"")
)


consolidated.Grad<- data.frame("group"=c("Poverty Graduation Program","","" ),
                               "Reg 1"=c(I2_Grad_All,ns_Grad_All,""),
                               "Reg 2"=c(I2_Grad_Depression,ns_Grad_Depression,""),
                               "Reg 3"=c(I2_Grad_Stress_Anx,ns_Grad_Stress_Anx,""),
                               "Reg 4"=c(I2_Grad_Happy_Sat,ns_Grad_Happy_Sat,"")
)


consolidated.Lottery<- data.frame("group"=c("Lottery Win","","" ),
                                  "Reg 1"=c(I2_Lottery_All,ns_Lottery_All,""),
                                  "Reg 2"=c('-','-',""),
                                  "Reg 3"=c(I2_Lottery_Stress_Anx,ns_Lottery_Stress_Anx,""),
                                  "Reg 4"=c(I2_Lottery_Happy_Sat,ns_Lottery_Happy_Sat,"")
)


consolidated.Asset<- data.frame("group"=c("Asset Transfer","","" ),
                                "Reg 1"=c(I2_Asset_All,ns_Asset_All,""),
                                "Reg 2"=c(I2_Asset_Depression,ns_Asset_Depression,""),
                                "Reg 3"=c(I2_Asset_Stress_Anx,ns_Asset_Stress_Anx,""),
                                "Reg 4"=c(I2_Asset_Happy_Sat,ns_Asset_Happy_Sat,"")
)


consolidated.Healthcare<- data.frame("group"=c("Health Insurance Provision","","" ),
                                     "Reg 1"=c(I2_Healthcare_All,ns_Healthcare_All,""),
                                     "Reg 2"=c(I2_Healthcare_Depression,ns_Healthcare_Depression,""),
                                     "Reg 3"=c(I2_Healthcare_Stress_Anx,ns_Healthcare_Stress_Anx,""),
                                     "Reg 4"=c(I2_Healthcare_Happy_Sat,ns_Healthcare_Happy_Sat,"")
)
...
pooled.tex <- xtable(consolidated_final,
                     caption="Heterogeneity Statistic",
                     align=c(
                       "l{0.01cm}",
                       "l{0.3cm}",
                       "c{0.3cm}",
...
print(pooled.tex, file = "tables/I2.tex", compress = FALSE, 
      include.rownames=FALSE,
      #hline.after = c(-1,0,0,4,8,12,16,23,23),
      # sanitize.colnames.function=bold, 
      add.to.row = addtorow,
